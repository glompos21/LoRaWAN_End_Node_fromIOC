...
/**
  ...
  */
#define SYS_BUTTON1_GPIO_CLK_DISABLE()     __HAL_RCC_GPIOA_CLK_DISABLE()
/**
...
/**
  ...
  */
#ifndef H_EXTI_0
#define H_EXTI_0                           sys_hpb_exti[SYS_BUTTON1]
#endif
...
/**
  ...
  */
#define SYS_BUTTON3_GPIO_CLK_DISABLE()     __HAL_RCC_GPIOC_CLK_DISABLE()
/**
...
/**
  ...
  */
#ifndef H_EXTI_6
#define H_EXTI_6                           sys_hpb_exti[SYS_BUTTON3]
#endif
...
/**
  ...
  */
#define SYS_BUTTON2_GPIO_CLK_DISABLE()     __HAL_RCC_GPIOA_CLK_DISABLE()
/**
...
/**
  ...
  */
#ifndef H_EXTI_1
#define H_EXTI_1                           sys_hpb_exti[SYS_BUTTON2]
#endif
...
/**
  ...
  */
#define SYS_BUTTONx_GPIO_CLK_ENABLE(__INDEX__)    do { if ((__INDEX__) == SYS_BUTTON1) SYS_BUTTON1_GPIO_CLK_ENABLE(); else if ((__INDEX__) == SYS_BUTTON3) SYS_BUTTON3_GPIO_CLK_ENABLE(); else if ((__INDEX__) == SYS_BUTTON2) SYS_BUTTON2_GPIO_CLK_ENABLE();} while(0)

/**
  * @brief Disable all Buttons clock
  */
#define SYS_BUTTONx_GPIO_CLK_DISABLE(__INDEX__)    do { if ((__INDEX__) == SYS_BUTTON1) SYS_BUTTON1_GPIO_CLK_DISABLE(); else if ((__INDEX__) == SYS_BUTTON3) SYS_BUTTON3_GPIO_CLK_DISABLE(); else if ((__INDEX__) == SYS_BUTTON2) SYS_BUTTON2_GPIO_CLK_DISABLE();} while(0)
...
/**
  ...
  * @return none
  */
void SYS_BUTTON3_EXTI_Callback(void);

/**
  * @brief Button SW2 EXTI line detection callback.
  * @return none
  */
void SYS_BUTTON2_EXTI_Callback(void);
