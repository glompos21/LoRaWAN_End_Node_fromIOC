...
int32_t SYS_PB_Init(Sys_Button_TypeDef Button, Sys_ButtonMode_TypeDef ButtonMode)
{
  ...
  static SYS_RES_EXTI_LineCallback button_callback[SYS_BUTTONn] = {SYS_BUTTON1_EXTI_Callback, SYS_BUTTON3_EXTI_Callback, SYS_BUTTON2_EXTI_Callback};
  ...
  static const uint32_t button_exti_line[SYS_BUTTONn] = {SYS_BUTTON1_EXTI_LINE, SYS_BUTTON3_EXTI_LINE, SYS_BUTTON2_EXTI_LINE};
...
__weak void SYS_BUTTON3_EXTI_Callback(void)
{
  /* This function should be implemented by the user application.
     It is called into this driver when an event on Button is triggered.*/
}

__weak void SYS_BUTTON2_EXTI_Callback(void)
{
  /* This function should be implemented by the user application.
     It is called into this driver when an event on Button is triggered.*/
}
